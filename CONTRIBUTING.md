# Contributing to **`azure-seed/azure-functions-elasticizer`**
...
Help us keep **`azure-seed/azure-functions-elasticizer`** open and inclusive. Please read and follow our [Code of Conduct][coc].
...
You can file new issues by filling out our [new issue form](https://github.com/azure-seed/azure-functions-elasticizer/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/azure-seed/azure-functions-elasticizer/pulls) for an open or closed PR that relates to your submission.
...
* Push your branch to GitHub:
    ...
    ```
* In GitHub, send a pull request to `azure-functions-elasticizer:master`.
...
the **`azure-seed/azure-functions-elasticizer`** change log**.
...
Samples: (even more [samples](https://github.com/azure-seed/azure-functions-elasticizer/commits/master))
```
...
* **afe** (*azure-functions-elasticizer*)
...
[coc]: https://github.com/azure-seed/azure-functions-elasticizer/blob/master/CODE_OF_CONDUCT.md
[github]: https://github.com/azure-seed/azure-functions-elasticizer
